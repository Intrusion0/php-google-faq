...
<head>
    ...
    $faq = [
        ...
        "<h2>Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?</h2>" => [
            ...
            [
                'answer' => "<p>Siamo costantemente al lavoro per garantire un'elevata sicurezza, proteggere la tua privacy e rendere Google ancora più efficace ed efficiente per te. Spendiamo centinaia di milioni di dollari ogni anno per la sicurezza e ci avvaliamo di esperti di fama mondiale in materia di sicurezza dei dati per mantenere le tue informazioni al sicuro. Abbiamo inoltre sviluppato strumenti per la sicurezza e la privacy di facile utilizzo come Google Dashboard, la verifica in due passaggi e Impostazioni annunci. Così, per quanto riguarda le informazioni che condividi con Google, hai il massimo controllo.</p>"
            ], 
            [
                'answer' => "<p>Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel <span><a href>Centro Google per la sicurezza online</a></span>.</p>"
            ], 
            [
                'answer' => "<p><span><a href>Scopri</a></span> quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo.</p>"
            ]
        ],
        "<h2>Perché il mio account è associato a un paese?</h2>" => [
            ...
            [
                'answer' => "<p><h3> Stabilire il paese associato al tuo account </h3>"
            ],
            [
            ...
            [
                'answer' => "<p>I viaggi frequenti solitamente non influiscono sul paese associato al tuo account. Se ti trasferisci in un altro paese, potrebbe occorrere circa un anno per aggiornare l'associazione del paese.</p>"
            ],
            [
                'answer' => "<p>Se il paese associato al tuo account non corrisponde al tuo paese di residenza, il motivo potrebbe essere la differenza tra il paese in cui lavori e il paese in cui risiedi, l'installazione di una rete privata virtuale (VPN) per mascherare il tuo indirizzo IP oppure la residenza vicino a un confine territoriale. <span><a href>Contattaci</a></span> se ritieni che il paese associato al tuo account sia sbagliato.</p>"
            ],
        ],
        "<h2>Come faccio a rimuovere informazioni su di me dai risultati di ricerca di Google?</h2>" => [
            [
                'answer' => "<p>I risultati di ricerca di Google rispecchiano i contenuti pubblicamente disponibili sul Web. I motori di ricerca non possono rimuovere i contenuti direttamente dai siti web, quindi rimuovere risultati di ricerca da Google non consente di rimuovere i contenuti dal Web. Se desideri rimuovere qualcosa dal Web, devi <span><a href>contattare il webmaster</a></span> del sito su cui sono pubblicati i contenuti e chiedergli di apportare una modifica. Inoltre, se, ai sensi delle leggi europee per la protezione dei dati, desideri richiedere la rimozione di determinate informazioni su di te visualizzate nei risultati di ricerca di Google, <span><a href>fai clic qui</a></span>. Una volta che i contenuti saranno stati rimossi e che Google avrà rilevato l'aggiornamento, le informazioni non verranno più visualizzate nei risultati di ricerca di Google. In caso di una richiesta di rimozione urgente, è inoltre possibile <span><a href>visitare la nostra pagina di assistenza per avere ulteriori informazioni</a></span>.</p>"
            ] 
        ],
    ...
    <main>
        <div class="container-faq">
            <?php
                ...
                foreach ($faq as $requests => $answers) {
                    echo $requests;
